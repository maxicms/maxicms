...
define('LANG_REG_CFG_NOTIFY_OLD_AUTH_HINT', 'Для пользователей, зарегистрированных до версии MaxiCMS 2.12.1, чтобы перейти на <a target="_blank" href="https://docs.maxicms.ru/manual/components/auth#вкладка-авторизация">новую систему хранения паролей</a>.');
