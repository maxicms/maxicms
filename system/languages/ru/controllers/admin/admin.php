<?php
    ...
    define('LANG_CP_DASHBOARD_NEWS',            'Новости MaxiCMS');
    ...
    define('LANG_CP_DASHBOARD_SI_ICMS',         'Версия MaxiCMS');
    ...
    define('LANG_CP_CONTENT_CATS_TITLES_HINT',  'Для создания сразу нескольких категорий каждая из них должна быть на новой строке.<br>Дополнительная вложенность задается знаком дефис перед названием категории<br><a href="https://docs.maxicms.ru/manual/content/cats" target="_blank">Подробная инструкция</a>');
    ...
    define('LANG_CP_SEOMETA_HINT_PATTERN_DOC',  'Подробнее в <a target="_blank" href="https://docs.maxicms.ru/manual/settings/seo-patterns">документации</a>.');
    ...
    define('LANG_CP_MENU_ITEM_ACTION_URL_HINT', 'Для внутренних ссылок начальный слэш не указывается<br/>Внешние ссылки должны начинаться с http(s)://<br/>Можно указывать <a href="https://docs.maxicms.ru/manual/menu/special" target="_blank">специальные ссылки</a>');
    ...
    define('LANG_CP_WIDGETS_DSCH_ERROR',        'Текущий шаблон админпанели не поддерживает динамические схемы виджетов. <a target="_blank" href="https://docs.maxicms.ru/manual/widgets">Подробнее...</a>');
    ...
    define('LANG_CP_SETTINGS_CHECK_UPDATES',    'Автоматически проверять наличие обновлений MaxiCMS при входе администратора');
    ...
    define('LANG_CP_ADDONS_CURL_ERROR',         'Просмотр каталога невозможен, поскольку на сервере отсутствует CURL. Вы можете выбрать дополнения из <a target="_blank" href="https://maxicms.ru/addons">официального каталога</a>.');
    define('LANG_CP_INSTALL_PACKAGE_LINK_HINT', 'Например, скопировав ссылку на скачивание из <a target="_blank" href="https://maxicms.ru/addons">официального каталога дополнений</a>');
    ...
    define('LANG_CP_INSTALL_COMPATIBILITY_YES', 'Совместимо с вашей версией MaxiCMS');
    define('LANG_CP_INSTALL_COMPATIBILITY_NO',  'Не тестировался с вашей версией MaxiCMS');
    ...
    define('LANG_CP_PACKAGE_DELETE_HINT',       'Настоятельно рекомендуем вручную удалить все файлы, указанные ниже, они больше не используются. У MaxiCMS нет прав доступа для удаления (и не должно быть).');
    ...
    define('LANG_CP_INSTALL_FTP_PERM',          'MaxiCMS не смог скопировать содержимое пакета, поскольку не хватает прав доступа.');
    ...
    define('LANG_CP_PACKAGE_TYPE_SYSTEM_UPDATE', 'Пакет обновления MaxiCMS');
    define('LANG_CP_PACKAGE_TYPE_SYSTEM_INSTALL', 'Пакет обновления MaxiCMS');
    ...
    define('LANG_CP_FTP_PATH_HINT',             '<a href="https://docs.maxicms.ru/manual/addons/ftppath" target="_blank">Как правильно указать путь?</a>');
    ...
    define('LANG_CP_FTP_BAD_ROOT',              'Ошибка пути: MaxiCMS 2 не найдена в <strong>%s</strong>');
    ...
    define('LANG_CP_FTP_SKIP_HINT',         'Пропустите шаг, если автоматический доступ на FTP невозможен и вы используете ручной способ установки описанный в <a href="https://docs.maxicms.ru/manual/addons">инструкции</a>');
    ...
    define('LANG_CP_UPDATE_CHECK',                  'Проверить обновления MaxiCMS');
    ...
    define('LANG_HELP_URL_CONTENT',                 'https://docs.maxicms.ru/manual/content');
    define('LANG_HELP_URL_CONTENT_CATS',            'https://docs.maxicms.ru/manual/content/cats');
    define('LANG_HELP_URL_CTYPES',                  'https://docs.maxicms.ru/manual/ctypes');
    define('LANG_HELP_URL_CTYPES_BASIC',            'https://docs.maxicms.ru/manual/ctypes/add');
    define('LANG_HELP_URL_CTYPES_LABELS',           'https://docs.maxicms.ru/manual/ctypes/labels');
    define('LANG_HELP_URL_CTYPES_FIELDS',           'https://docs.maxicms.ru/manual/ctypes/fields');
    define('LANG_HELP_URL_CTYPES_FIELD',            'https://docs.maxicms.ru/manual/ctypes/fields/add');
    define('LANG_HELP_URL_CTYPES_PROPS',            'https://docs.maxicms.ru/manual/ctypes/props');
    define('LANG_HELP_URL_CTYPES_PROP',             'https://docs.maxicms.ru/manual/ctypes/props/add');
    define('LANG_HELP_URL_CTYPES_FILTERS',          'https://docs.maxicms.ru/manual/ctypes/filters');
    define('LANG_HELP_URL_CTYPES_FILTERS_ADD',      'https://docs.maxicms.ru/manual/ctypes/filters/add');
    define('LANG_HELP_URL_CTYPES_DATASETS',         'https://docs.maxicms.ru/manual/ctypes/datasets');
    define('LANG_HELP_URL_CTYPES_DATASET',          'https://docs.maxicms.ru/manual/ctypes/datasets/add');
    define('LANG_HELP_URL_CTYPES_RELATIONS',        'https://docs.maxicms.ru/manual/ctypes/relations');
    define('LANG_HELP_URL_CTYPES_PERMS',            'https://docs.maxicms.ru/manual/ctypes/permissions');
    define('LANG_HELP_URL_CTYPES_MODERATORS',       'https://docs.maxicms.ru/manual/ctypes/moderators');
    define('LANG_HELP_URL_MENU',                    'https://docs.maxicms.ru/manual/menu');
    define('LANG_HELP_URL_WIDGETS',                 'https://docs.maxicms.ru/manual/widgets');
    define('LANG_HELP_URL_WIDGETS_CFG',             'https://docs.maxicms.ru/manual/widgets/config');
    define('LANG_HELP_URL_WIDGETS_PAGES',           'https://docs.maxicms.ru/manual/widgets/pages');
    define('LANG_HELP_URL_COMPONENTS',              'https://docs.maxicms.ru/manual/components');
    define('LANG_HELP_URL_INSTALL',                 'https://docs.maxicms.ru/manual/addons');
    define('LANG_HELP_URL_COM_FORMS',               'https://docs.maxicms.ru/manual/components/forms');
    define('LANG_HELP_URL_COM_REDIRECT',            'https://docs.maxicms.ru/manual/components/redirect');
    define('LANG_HELP_URL_COM_AUTH',                'https://docs.maxicms.ru/manual/components/auth');
    define('LANG_HELP_URL_COM_MODERATION',          'https://docs.maxicms.ru/manual/components/moderation');
    define('LANG_HELP_URL_COM_ACTIVITY',            'https://docs.maxicms.ru/manual/components/activity');
    define('LANG_HELP_URL_COM_GROUPS',              'https://docs.maxicms.ru/manual/components/groups');
    define('LANG_HELP_URL_COM_RECAPTCHA',           'https://docs.maxicms.ru/manual/components/recaptcha');
    define('LANG_HELP_URL_COM_COMMENTS',            'https://docs.maxicms.ru/manual/components/comments');
    define('LANG_HELP_URL_COM_IMAGES',              'https://docs.maxicms.ru/manual/components/images');
    define('LANG_HELP_URL_COM_SUBSCRIPTIONS',       'https://docs.maxicms.ru/manual/components/subscriptions');
    define('LANG_HELP_URL_COM_USERS',               'https://docs.maxicms.ru/manual/components/users');
    define('LANG_HELP_URL_COM_USERS_MIGRATON',      'https://docs.maxicms.ru/manual/components/users/migrations');
    define('LANG_HELP_URL_COM_MARKITUP',            'https://docs.maxicms.ru/manual/components/markitup');
    define('LANG_HELP_URL_COM_RATING',              'https://docs.maxicms.ru/manual/components/rating');
    define('LANG_HELP_URL_COM_SEARCH',              'https://docs.maxicms.ru/manual/components/search');
    define('LANG_HELP_URL_COM_TAGS',                'https://docs.maxicms.ru/manual/components/tags');
    define('LANG_HELP_URL_COM_RSS',                 'https://docs.maxicms.ru/manual/components/rss');
    define('LANG_HELP_URL_COM_SITEMAP',             'https://docs.maxicms.ru/manual/components/sitemap');
    define('LANG_HELP_URL_COM_PHOTOS',              'https://docs.maxicms.ru/manual/components/photos');
    define('LANG_HELP_URL_COM_CSP',                 'https://docs.maxicms.ru/manual/components/csp');
    define('LANG_HELP_URL_USERS',                   'https://docs.maxicms.ru/manual/users');
    define('LANG_HELP_URL_USERS_USER',              'https://docs.maxicms.ru/manual/users/user');
    define('LANG_HELP_URL_USERS_GROUP',             'https://docs.maxicms.ru/manual/users/group');
    define('LANG_HELP_URL_SETTINGS',                'https://docs.maxicms.ru/manual/settings');
    define('LANG_HELP_URL_SETTINGS_GLOBAL',         'https://docs.maxicms.ru/manual/settings/global');
    define('LANG_HELP_URL_SETTINGS_MIME',           'https://docs.maxicms.ru/manual/settings/mime');
    define('LANG_HELP_URL_SETTINGS_SCHEDULER',      'https://docs.maxicms.ru/manual/settings/scheduler');
    define('LANG_HELP_URL_CHECK_NESTED',            'https://docs.maxicms.ru/manual/settings/check_nested');
    define('LANG_HELP_URL_SETTINGS_SCHEDULER_TASK', 'https://docs.maxicms.ru/manual/settings/scheduler/task');
    define('LANG_HELP_URL_EVENTS',                  'https://docs.maxicms.ru/manual/settings/events');
    define('LANG_HELP_URL_COM_MESSAGES',                'https://docs.maxicms.ru/manual/components/messages');
