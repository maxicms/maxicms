<?php
    ...
    define('LANG_CP_DASHBOARD_NEWS',            'MaxiCMS news');
    ...
    define('LANG_CP_DASHBOARD_SI_ICMS',         'MaxiCMS version');
    ...
    define('LANG_CP_CONTENT_CATS_TITLES_HINT',  'Enter one item per line to create multiple categories<br>Add a hyphen before the title to make a nested category<br><a href="https://docs.maxicms.ru/en/manual/content/cats" target="_blank">Detailed Manual</a>');
    ...
    define('LANG_CP_SEOMETA_HINT_PATTERN_DOC',  'More details in <a target="_blank" href="https://docs.maxicms.ru/en/manual/settings/seo-patterns">the documentation</a>.');
    ...
    define('LANG_CP_MENU_ITEM_ACTION_URL_HINT', 'Internal links should come without a leading slash<br/>External links should start with http(s)://<br/>You can enter <a href="https://docs.maxicms.ru/en/manual/menu/special" target="_blank">Special Links</a>');
    ...
    define('LANG_CP_WIDGETS_DSCH_ERROR',        'The current admin panel template does not support dynamic widget scheme. <a target="_blank" href="https://docs.maxicms.ru/en/manual/widgets">More details...</a>');
    ...
    define('LANG_CP_SETTINGS_CHECK_UPDATES',    'Automatically check for MaxiCMS updates when admin logs in');
    ...
    define('LANG_CP_ADDONS_CURL_ERROR',         'Browse the add-ons catalog failed, because CURL is not available on the server. You can select addons from a <a target="_blank" href="https://maxicms.ru/addons">official add-ons catalog</a>.');
    define('LANG_CP_INSTALL_PACKAGE_LINK_HINT', 'For example, by copying a download link from the <a target="_blank" href="https://maxicms.ru/addons">official add-ons catalog</a>');
    ...
    define('LANG_CP_INSTALL_COMPATIBILITY_YES', 'Compatible with your MaxiCMS version');
    define('LANG_CP_INSTALL_COMPATIBILITY_NO',  'Not tested with your MaxiCMS version');
    ...
    define('LANG_CP_PACKAGE_DELETE_HINT',       'We strongly recommend that you manually delete all the files listed below, they are no longer used. MaxiCMS does not have permission to delete (and should not).');
    ...
    define('LANG_CP_INSTALL_FTP_PERM',          'MaxiCMS could not copy the contents of the package because it is missing permissions.');
    ...
    define('LANG_CP_PACKAGE_TYPE_SYSTEM_UPDATE', 'MaxiCMS service pack');
    define('LANG_CP_PACKAGE_TYPE_SYSTEM_INSTALL', 'MaxiCMS service pack');
    ...
    define('LANG_CP_FTP_PATH_HINT',             '<a href="https://docs.maxicms.ru/en/manual/addons/ftppath" target="_blank">How to specify correct path?</a>');
    ...
    define('LANG_CP_FTP_BAD_ROOT',              'Bad root path: MaxiCMS 2 not found in <strong>%s</strong>');
    ...
    define('LANG_CP_FTP_SKIP_HINT',             'Skip this step if automatic FTP upload is impossible and you follow the manual installation method described in the <a href="https://docs.maxicms.ru/en/manual/addons">Manual</a>');
    ...
    define('LANG_CP_UPDATE_CHECK',                  'Check for MaxiCMS updates');
    ...
    define('LANG_HELP_URL_CONTENT',                 'https://docs.maxicms.ru/en/manual/content');
    define('LANG_HELP_URL_CONTENT_CATS',            'https://docs.maxicms.ru/en/manual/content/cats');
    define('LANG_HELP_URL_CTYPES',                  'https://docs.maxicms.ru/en/manual/ctypes');
    define('LANG_HELP_URL_CTYPES_BASIC',            'https://docs.maxicms.ru/en/manual/ctypes/add');
    define('LANG_HELP_URL_CTYPES_LABELS',           'https://docs.maxicms.ru/en/manual/ctypes/labels');
    define('LANG_HELP_URL_CTYPES_FIELDS',           'https://docs.maxicms.ru/en/manual/ctypes/fields');
    define('LANG_HELP_URL_CTYPES_FIELD',            'https://docs.maxicms.ru/en/manual/ctypes/fields/add');
    define('LANG_HELP_URL_CTYPES_PROPS',            'https://docs.maxicms.ru/en/manual/ctypes/props');
    define('LANG_HELP_URL_CTYPES_PROP',             'https://docs.maxicms.ru/en/manual/ctypes/props/add');
    define('LANG_HELP_URL_CTYPES_FILTERS',          'https://docs.maxicms.ru/en/manual/ctypes/filters');
    define('LANG_HELP_URL_CTYPES_FILTERS_ADD',      'https://docs.maxicms.ru/en/manual/ctypes/filters/add');
    define('LANG_HELP_URL_CTYPES_DATASETS',         'https://docs.maxicms.ru/en/manual/ctypes/datasets');
    define('LANG_HELP_URL_CTYPES_DATASET',          'https://docs.maxicms.ru/en/manual/ctypes/datasets/add');
    define('LANG_HELP_URL_CTYPES_RELATIONS',        'https://docs.maxicms.ru/en/manual/ctypes/relations');
    define('LANG_HELP_URL_CTYPES_PERMS',            'https://docs.maxicms.ru/en/manual/ctypes/permissions');
    define('LANG_HELP_URL_CTYPES_MODERATORS',       'https://docs.maxicms.ru/en/manual/ctypes/moderators');
    define('LANG_HELP_URL_MENU',                    'https://docs.maxicms.ru/en/manual/menu');
    define('LANG_HELP_URL_WIDGETS',                 'https://docs.maxicms.ru/en/manual/widgets');
    define('LANG_HELP_URL_WIDGETS_CFG',             'https://docs.maxicms.ru/en/manual/widgets/config');
    define('LANG_HELP_URL_WIDGETS_PAGES',           'https://docs.maxicms.ru/en/manual/widgets/pages');
    define('LANG_HELP_URL_COMPONENTS',              'https://docs.maxicms.ru/en/manual/components');
    define('LANG_HELP_URL_INSTALL',                 'https://docs.maxicms.ru/en/manual/addons');
    define('LANG_HELP_URL_COM_FORMS',               'https://docs.maxicms.ru/en/manual/components/forms');
    define('LANG_HELP_URL_COM_REDIRECT',            'https://docs.maxicms.ru/en/manual/components/redirect');
    define('LANG_HELP_URL_COM_AUTH',                'https://docs.maxicms.ru/en/manual/components/auth');
    define('LANG_HELP_URL_COM_ACTIVITY',            'https://docs.maxicms.ru/en/manual/components/activity');
    define('LANG_HELP_URL_COM_GROUPS',              'https://docs.maxicms.ru/en/manual/components/groups');
    define('LANG_HELP_URL_COM_RECAPTCHA',           'https://docs.maxicms.ru/en/manual/components/recaptcha');
    define('LANG_HELP_URL_COM_COMMENTS',            'https://docs.maxicms.ru/en/manual/components/comments');
    define('LANG_HELP_URL_COM_IMAGES',              'https://docs.maxicms.ru/en/manual/components/images');
    define('LANG_HELP_URL_COM_SUBSCRIPTIONS',       'https://docs.maxicms.ru/en/manual/components/subscriptions');
    define('LANG_HELP_URL_COM_USERS',               'https://docs.maxicms.ru/en/manual/components/users');
    define('LANG_HELP_URL_COM_MODERATION',          'https://docs.maxicms.ru/en/manual/components/moderation');
    define('LANG_HELP_URL_COM_USERS_MIGRATON',      'https://docs.maxicms.ru/en/manual/components/users/migrations');
    define('LANG_HELP_URL_COM_MARKITUP',            'https://docs.maxicms.ru/en/manual/components/markitup');
    define('LANG_HELP_URL_COM_RATING',              'https://docs.maxicms.ru/en/manual/components/rating');
    define('LANG_HELP_URL_COM_SEARCH',              'https://docs.maxicms.ru/en/manual/components/search');
    define('LANG_HELP_URL_COM_TAGS',                'https://docs.maxicms.ru/en/manual/components/tags');
    define('LANG_HELP_URL_COM_RSS',                 'https://docs.maxicms.ru/en/manual/components/rss');
    define('LANG_HELP_URL_COM_SITEMAP',             'https://docs.maxicms.ru/en/manual/components/sitemap');
    define('LANG_HELP_URL_COM_PHOTOS',              'https://docs.maxicms.ru/en/manual/components/photos');
    define('LANG_HELP_URL_COM_CSP',                 'https://docs.maxicms.ru/en/manual/components/csp');
    define('LANG_HELP_URL_USERS',                   'https://docs.maxicms.ru/en/manual/users');
    define('LANG_HELP_URL_USERS_USER',              'https://docs.maxicms.ru/en/manual/users/user');
    define('LANG_HELP_URL_USERS_GROUP',             'https://docs.maxicms.ru/en/manual/users/group');
    define('LANG_HELP_URL_SETTINGS',                'https://docs.maxicms.ru/en/manual/settings');
    define('LANG_HELP_URL_SETTINGS_GLOBAL',         'https://docs.maxicms.ru/en/manual/settings/global');
    define('LANG_HELP_URL_SETTINGS_MIME',           'https://docs.maxicms.ru/en/manual/settings/mime');
    define('LANG_HELP_URL_SETTINGS_SCHEDULER',      'https://docs.maxicms.ru/en/manual/settings/scheduler');
    define('LANG_HELP_URL_CHECK_NESTED',            'https://docs.maxicms.ru/en/manual/settings/check_nested');
    define('LANG_HELP_URL_SETTINGS_SCHEDULER_TASK', 'https://docs.maxicms.ru/en/manual/settings/scheduler/task');
    define('LANG_HELP_URL_EVENTS',                  'https://docs.maxicms.ru/en/manual/settings/events');
    define('LANG_HELP_URL_COM_MESSAGES',                'https://docs.maxicms.ru/en/manual/components/messages');
