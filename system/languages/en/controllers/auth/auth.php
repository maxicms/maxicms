...
define('LANG_REG_CFG_NOTIFY_OLD_AUTH_HINT', 'For users registered to MaxiCMS version 2.12.1, to switch to a <a target="_blank" href="https://docs.maxicms.ru/manual/components/auth#вкладка-авторизация">new password storage system</a>.');
