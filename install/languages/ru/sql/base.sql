...
(2, 'Контент', 'content', 1, NULL, 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 0),
...
(13, 'Модерация', 'moderation', 1, NULL, 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 1),
(19, 'Загрузка изображений', 'images', 1, NULL, 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 1),
(23, 'Wysiwyg редакторы', 'wysiwygs', 1, NULL, 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 1),
(25, 'Мультиязычность', 'languages', 1, '---\nservice: google\n', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 1),
(26, 'Типограф', 'typograph', 1, NULL, 'MaxiCMS Team', 'https://maxicms.ru', '2.0', 1);
...
(1, NULL, 'text', 'Текстовый блок', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(2, 'users', 'list', 'Список пользователей', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(3, NULL, 'menu', 'Меню', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(4, 'content', 'list', 'Список контента', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(5, 'content', 'categories', 'Категории', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(8, 'users', 'online', 'Кто онлайн', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(9, 'users', 'avatar', 'Аватар пользователя', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(11, 'content', 'slider', 'Слайдер контента', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(12, 'auth', 'auth', 'Форма авторизации', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(14, NULL, 'html', 'HTML блок', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(15, 'content', 'filter', 'Фильтр контента', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(19, 'auth', 'register', 'Форма регистрации', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(20, NULL, 'template', 'Элементы шаблона', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(21, 'content', 'fields', 'Поля контента', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL),
(23, 'content', 'author', 'Автор записи', 'MaxiCMS Team', 'https://maxicms.ru', '2.0', NULL);
